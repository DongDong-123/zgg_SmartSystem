...
class Execute(object):
    def __init__(self):
        ...
        # 登录
        self.drivers = front_login(self.USER, self.PASSWORD)
        self.driver = self.drivers.get("{}/user/market/order.html?state=3".format(ReadConfig().get_user_url()))
        self.row = 0
    ...
    def get_code_num(self):
        # self.driver.get("{}/user/market/order.html?state=3".format(ReadConfig().get_user_url()))
